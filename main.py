...
def main():
    ...
    parser.add_argument("--prompt-count-multiplier", action="store_true", default=1, help="Prompt count multiplier.")
    parser.add_argument("--max-prompt-count", action="store_true", default=1000, help="Maximum prompt count per output prompt file.")
